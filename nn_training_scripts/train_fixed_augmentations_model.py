...
if __name__ == '__main__':
    ...
    # The filename should be adjusted for each experiment.
    ...
    # Set the optimizer and momentum, specify gradient clipping value
    # with the clipnorm option to ensure stability
