...
"""
This file was used to create mixed examples using simple linear interpolation of mean latent codes between closely related classes, using constant weighting and four mixed examples per parent pair.
...
OUT_DIR = DATASET + '_interpolation2_final_filter_3_mean'
...
with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as session:
    ...
    if MODE == 'one_level':
        ...
        def generate_and_save_samples(tag):
            ...
            np.save(OUT_DIR + '/' + 'x_augmentation_array_mean', x_augmentation_array) 
            np.save(OUT_DIR + '/' + 'y_augmentation_array_mean', y_augmentation_array)   
