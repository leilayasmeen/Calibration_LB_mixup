...
"""
This file was used to create mixed examples using spherical linear interpolation of sampled latent codes, using constant weighting and four mixed examples per parent pair.
...
OUT_DIR = DATASET + '_interpolation3_final_filter_3_sampled'
