...
"""
This file was used to create mixed examples using spherical linear interpolation of mean latent codes between closely related class pairs, using constant weighting and four mixed examples per parent pair.
...
OUT_DIR = DATASET + '_interpolation4_final_filter_3_mean'
