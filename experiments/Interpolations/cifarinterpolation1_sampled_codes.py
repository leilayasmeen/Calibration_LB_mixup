...
"""
This file was used to create mixed examples using simple linear interpolation of sampled latent codes, using constant uniform weighting and four mixed examples per parent pair.
