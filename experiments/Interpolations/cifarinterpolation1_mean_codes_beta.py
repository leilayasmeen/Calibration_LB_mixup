...
"""
This file was used to create mixed examples using simple linear interpolation of mean latent codes, using constant uniform weighting and four mixed examples per parent pair.
...
OUT_DIR = DATASET + '_interpolation1_final_filter_3_mean_beta'
...
with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as session:
    ...
    if MODE == 'one_level':
        ...
        def generate_and_save_samples(tag):
            ...
            np.save(OUT_DIR + '/' + 'x_augmentation_array_mean_beta', x_augmentation_array) 
            np.save(OUT_DIR + '/' + 'y_augmentation_array_mean_beta', y_augmentation_array)  
